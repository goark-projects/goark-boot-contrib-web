...
const (
	...
	// BeanNameSessionAttributesFilter 是默认 MVC SessionAttributes 过滤器 Bean 名称。
	BeanNameSessionAttributesFilter = "goark.boot.web.mvc.sessionAttributesFilter"
	...
	// BeanNameValidator 是默认 Web 校验器 Bean 名称。
	BeanNameValidator = "goark.boot.web.validator"
	// BeanNameValidatorConfigurer 是默认 Web 校验器配置器 Bean 名称。
	BeanNameValidatorConfigurer = "goark.boot.web.validatorConfigurer"
...
const (
	...
	// DefaultSessionAttributesFilterEnabled 表示默认启用 MVC SessionAttributes 过滤器。
	DefaultSessionAttributesFilterEnabled = true
